...
const AboutSection = () => (
  <div className="terminal-output animate-section">
    <p className="text-xl text-foreground mb-2 typing-line font-semibold" style={{ animationDelay: "0s" }}>
      V. Oliver Walsh
    </p>
    <p className="text-sm text-[hsl(var(--text-secondary))] mb-5 typing-line" style={{ animationDelay: "0.1s" }}>
      applied ai engineer bridging frontier research, infrastructure, and product.
      <span className="block mt-2">
        shipping zero-to-one across enterprise platforms and early-stage startups, drawn to work where the hard parts are still research problems and the output has to hold up in the real world.
      </span>
    </p>
  ...
  <div className="terminal-output space-y-6 pb-4">
    ...
    <TerminalJob
      ...
      bullets={[
        ...
        "led design of storage layer, model infra, extensible Python sdk, zkml integration, confidential compute H100 GPUs & TEEs.",
    ...
    <TerminalJob
      ...
      bullets={[
        ...
        "model explainability dri: integrated Fiddler AI, architected audit pipeline capturing feature importances to Kafka and Snowflake across 12+ production models.",
        "migrated models from Sagemaker to Anyscale Ray training and serving, integrated Ray with Delta Lake.",
